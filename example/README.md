...
> This example shows how to use this package to listen to stream and build a widget.
...
If you faced any issue please fell free to [report any bugs](https://github.com/Vedsaga/check_network/issues)
If you want to contribute by adding new examples please fork the repository and submit a pull request.
Any feedback is welcome or any help to improve the package would be appreciated and help us to make the package better.
